...
SELECT EMP_NAME, SALARY*12 연봉, ((SALARY+SALARY*BONUS)*12) 총수령액, ((SALARY+SALARY*BONUS)*12)-((SALARY*12)*0.3) 실수령액
FROM EMPLOYEE;
...
SELECT EMP_NAME, SALARY, ((SALARY+SALARY*BONUS)*12)-((SALARY*12)*0.3) 실수령액, HIRE_DATE
FROM EMPLOYEE

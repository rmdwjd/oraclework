...
--   - 3개 정도의 샘플 데이터 추가하기
INSERT INTO TB_PUBLISHER VALUES (1, '길벗', null);
INSERT INTO TB_PUBLISHER VALUES (2, '다락원', NULL);
INSERT INTO TB_PUBLISHER VALUES (3, '민음사', NULL);
...
--   - 5개 정도의 샘플 데이터 추가하기
INSERT INTO TB_BOOK VALUES(1, '모두의 파이썬','이승찬', 18000, 1);
INSERT INTO TB_BOOK VALUES(2, '만화로 보는 IT 상식사전','윤진,이솔', 19500, 1);
INSERT INTO TB_BOOK VALUES(3, '영어 힐링 노트','이보영', 16000, 2);
INSERT INTO TB_BOOK VALUES(4, '어휘에 독해지면 독해가 된다','정치환', 9800, 2);
INSERT INTO TB_BOOK VALUES(5, '말 놓을 용기','이성민', 16000, 3);
...
CREATE TABLE TB_MEMBER(
    ...
    MEBER_NAME VARCHAR(20) CONSTRAINT MEMBER_NN_NAME NOT NULL,
    GENDER CHAR(1) CONSTRAINT MEMEBER_CK_GEN CHECK(GENDER IN ('M','F')),
    ADDRESS VARCHAR2(70),
    PHONE VARCHAR2(13),
...
--   - 5개 정도의 샘플 데이터 추가하기
INSERT INTO TB_MEMBER VALUES (1, 'user01', '1234', '김길동', 'M', null, null, 'N', DEFAULT);
INSERT INTO TB_MEMBER VALUES (2, 'user02', '1234', '이길우', 'M', null, null, 'N', DEFAULT);
INSERT INTO TB_MEMBER VALUES (3, 'user03', '1234', '정이동', 'F', null, null, 'N', DEFAULT);
INSERT INTO TB_MEMBER VALUES (4, 'user04', '1234', '박민우', 'F', null, null, 'N', DEFAULT);
INSERT INTO TB_MEMBER VALUES (5, 'user05', '1234', '최지민', 'M', null, null, 'N', DEFAULT);
...
INSERT INTO TB_RENT VALUES(3, 2, 3, DEFAULT);
